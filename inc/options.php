...
add_submenu_page('lapizzeria_options','Reservations','Reservations','administrator','lapizzeria_reservations','reservations');
}
    ...
    <div class="wrap">
        ...
        <form action="options.php" method="post">
            ...
            <tr valign="top">
                ...
                <td>
                    <input type="number" max="21" min="10" name="lapizzeria_gmap_zoom" value="<?php echo esc_attr(get_option('lapizzeria_gmap_zoom')); ?>">
                </td>
            </tr>
            <tr valign="top">
        ...
        <tbody>
            ...
            foreach($reservations as $reservation): ?>
                <tr>
                    ...
                    <td>
                        <a href="#" class="remove_reservation" data-reservation="<?php echo $reservation['id']; ?>">
                         Remove
                        </a>
                    </td>
                </tr>
